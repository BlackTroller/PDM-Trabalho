...
public class ExtraquestionFragment extends Fragment {
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                totalAnswers = document.getLong("totalAnswers").intValue();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mContentView = inflater.inflate(R.layout.fragment_extraquestion, container, false);
        t1_question = mContentView.findViewById(R.id.question1);
    ...
    private void updateQuestion(){
        ...
        if(total > 1){
            ...
            Intent i = new Intent(ExtraquestionFragment.this.getActivity(), ResultActivity.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("ExtraQuestions").child(String.valueOf(getRandomNumber()));
    ...
    public void reverseTimer(int seconds, TextView tv){
        new CountDownTimer(seconds * 1000 + 1000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent myIntent = new Intent(ExtraquestionFragment.this.getActivity(), ResultActivity.class);
